...
func mmc(u int64, n int32, c string) *productcatalogservice_rest_types.Money {
	return &productcatalogservice_rest_types.Money{Units: &u, Nanos: &n, CurrencyCode: &c}
}
func mm(u int64, n int32) *productcatalogservice_rest_types.Money { return mmc(u, n, "") }

func TestIsValid(t *testing.T) {
	tests := []struct {
		name string
		in   *productcatalogservice_rest_types.Money
		want bool
	}{
...
func TestAreSameCurrency(t *testing.T) {
	type args struct {
		l *productcatalogservice_rest_types.Money
		r *productcatalogservice_rest_types.Money
	}
	tests := []struct {
		name string
		args args
...
func TestNegate(t *testing.T) {
	tests := []struct {
		name string
		in   *productcatalogservice_rest_types.Money
		want *productcatalogservice_rest_types.Money
	}{
		{"zero", mm(0, 0), mm(0, 0)},
